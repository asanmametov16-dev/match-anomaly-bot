...
# Порядок обработки: уберём акценты → пунктуацию → числа-номера →
# суффиксы типа FC/SC → применим словарь алиасов.

# Суффиксы-аббревиатуры, не несущие смысла для матчинга
...
def normalize_team_name(name: str) -> str:
    ...
    Шаги: акценты → пунктуация → lowercase → числа → суффиксы FC/SC → алиасы.
    """
    ...
    # Убираем суффиксы-аббревиатуры в конце
    words = n.split()
